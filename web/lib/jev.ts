...
const criteria = [
  ...
  'All mandatory requirements are supported, and the description supports the requested activity or a format plausibly suited to optional mood preferences. Optional moods need not be stated literally.',
